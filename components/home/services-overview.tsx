...
const services = [
  {
    ...
    image: "/images/services/provider-enrollment.jpg",
  ...
  },
  {
    ...
    image: "/images/services/medical-coding.jpg",
  ...
  },
  {
    ...
    image: "/images/services/patient-demographics.jpg",
  ...
  },
  {
    ...
    image: "/images/services/eligibility.jpg",
  ...
  },
  {
    ...
    image: "/images/services/charge-capture.jpg",
  ...
  },
  {
    ...
    image: "/images/services/payment-posting.jpg",
  ...
  },
  {
    ...
    image: "/images/services/accounts-receivable.jpg",
...
// For placeholder images, we'll use a gradient with the service name
// In a real implementation, these would be actual image files
const serviceImages = services.map(service => {
  return {
    ...service,
    image: `/placeholder.jpg` // Using the existing placeholder image
  }
})
