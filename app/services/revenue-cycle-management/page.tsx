...
import { ArrowLeft, BarChart3, DollarSign, Clock, Users, FileCheck, Shield, ChevronRight, ArrowRight } from "lucide-react";
...
export default function RevenueCycleManagementPage() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      author: "Michael Chen",
      role: "CEO, Westside Medical Group"
    }
  ];
  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-20 relative" id="workflow">
        ...
        <div className="container relative z-10 pt-16">
          ...
          <div className="hidden lg:block relative">
            {/* 3D Isometric Grid */}
            <div className="relative h-[800px] perspective-[1000px]">
              {/* Central Element */}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative w-full h-full transform group-hover:scale-110 transition-transform duration-500">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-900 shadow-xl border border-white/10 overflow-hidden">
                          {/* Accent Corner */}
            ...
            <div className="flex justify-center mt-8 space-x-4">
              <button className="px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-sm transition-colors">
                Rotate View
              </button>
              <button className="px-4 py-2 bg-primary hover:bg-primary-dark text-white rounded-sm transition-colors">
                Explore All Steps
              </button>
            </div>
          </div>
      ...
      <section className="py-24 relative" id="solutions">
        ...
        <div className="absolute inset-0 bg-primary/5 mix-blend-multiply z-0"></div>
        <div className="absolute inset-0 bg-[url('/images/grid-pattern.svg')] bg-center opacity-5 z-0"></div>
        
        {/* Diagonal Accents */}
        <div className="absolute top-0 left-0 w-1/3 h-3 bg-gradient-to-r from-primary to-primary/20 z-0"></div>
        <div className="absolute bottom-0 right-0 w-1/3 h-3 bg-gradient-to-l from-primary to-primary/20 z-0"></div>
        
        {/* Decorative Elements */}
        <div className="absolute top-20 right-20 w-64 h-64 rounded-full border-[16px] border-primary/10 z-0"></div>
        ...
        <div className="container relative z-10">
          ...
          <div className="max-w-4xl mx-auto text-center mb-20">
            ...
            <h2 className="text-5xl md:text-6xl font-extrabold text-gray-900 mb-6 leading-tight">
              Comprehensive <span className="text-primary">RCM</span> Solutions
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              {rcmSolutions.slice(0, 2).map((solution, index) => (
                <div key={index} className="group relative">
                  ...
                  <div className="relative h-full overflow-hidden bg-white border border-gray-100 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:border-primary">
                    {/* Top Accent */}
                    <div className="absolute top-0 left-0 right-0 h-1 bg-primary transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
                    
                    {/* Content */}
                    <div className="p-6 md:p-8 h-full flex flex-col">
                      {/* Solution Number */}
                      <div className="absolute top-4 right-4 font-mono text-primary/30 text-xl font-bold">
                        {(index + 1).toString().padStart(2, '0')}
                      </div>
                      
                      {/* Icon */}
                      <div className="w-16 h-16 md:w-20 md:h-20 bg-primary/10 rounded-lg flex items-center justify-center text-4xl md:text-5xl mb-6 transform group-hover:scale-110 group-hover:bg-primary/20 transition-all duration-300">
                        {solution.icon}
                      </div>
                      ...
                      <div className="mt-auto">
                        <Link
                          href={solution.href}
                          className="inline-flex items-center text-primary font-bold group-hover:text-primary-dark transition-colors duration-300"
                        >
                          Explore Solution 
                          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-2 transform transition-transform duration-300 group-hover:translate-x-1">
          ...
          {/* CTA Section */}
          <div className="mt-20">
            <div className="bg-primary/10 border border-primary/20 rounded-lg p-10 max-w-5xl mx-auto">
              <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="mb-6 md:mb-0 md:mr-10 text-left">
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Ready to optimize your revenue cycle?</h3>
                  <p className="text-gray-600 max-w-xl">
                    Our team of experts will analyze your current processes and identify opportunities for improvement.
                  </p>
                </div>
                <div className="flex-shrink-0">
                  <Link href="/get-started" className="inline-block bg-primary hover:bg-primary-dark text-white font-bold py-4 px-8 rounded-lg transition-colors shadow-md hover:shadow-lg">
                    Schedule a Consultation
                  </Link>
                </div>
              </div>
      ...
      <section className="py-24 relative" id="benefits">
        ...
        <div className="absolute top-0 left-0 w-full h-px bg-primary/20 z-0"></div>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6 relative">
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          <p className="font-bold text-gray-900 text-sm">Dr. Sarah Johnson</p>
                          <p className="text-xs text-gray-600">Medical Director</p>
                        </div>
                      </div>
                    </div>
                  </div>
